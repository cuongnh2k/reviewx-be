...
public final class CommonListResponse<T> {
    ...
    public static <T> CommonListResponse<T> buildEmpty(Pageable pageable) {
    ...
    public static <T> CommonListResponse<T> build(Page<T> page) {
        return CommonListResponse
                .<T>builder()
    ...
    public static <T> CommonListResponse<T> build(Page<T> page, List<T> content) {
        return CommonListResponse
                .<T>builder()
                .page(page.getPageable().getPageNumber())
                .size(page.getPageable().getPageSize())
    ...
    public <R> CommonListResponse<R> map(Function<T, R> mapFunc) {
